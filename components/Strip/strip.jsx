...
const StatsDisplay = () => {
  return (
    <div className="flex flex-wrap justify-center md:gap-48 gap-12 p-8 mb-16 md:mt-[-80px]">
      <div className="flex-1 max-w-sm rounded-2xl border-solid border-orange-400 px-12 py-12 text-center text-white">
      ...
      <div className="flex-1 max-w-sm rounded-2xl border-solid border-emerald-400 px-12 py-12 text-center text-white">
        <div className="md:text-6xl text-4xl font-bold font-sans mb-3">
